...
STATUS = {
    ...
    "rostock": ("verified", "Tabelle 1 extracted from rostock-2026.pdf (131 per-m² pairs all match the PDF text); worked example reproduces exactly (A=6,88, B=-0,29, C=6,59). Baujahr factors embedded."),
